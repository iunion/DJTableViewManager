 ...
 */
typedef NS_ENUM(NSInteger, MQFamilyFontName)
{
    /**
 ...
 */
typedef NS_ENUM(NSInteger, MQFontName) {
    /**
     *  SystemFont
     */
...
// 所有字体名称
+ (nonnull NSDictionary *)allFamilyAndFonts;
// 一组字体名称
+ (nonnull NSArray *)fontsNameForFamilyName:(MQFamilyFontName)familyFontName;


+ (nullable UIFont *)fontForFontName:(MQFontName)fontName
                                size:(CGFloat)fontSize;

+ (nullable NSString *)fontNameToString:(MQFontName)fontName;
